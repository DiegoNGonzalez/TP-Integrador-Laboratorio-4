...
public class ClienteNegocioImpl implements ClienteNegocio {
	...
	public void verificarCliente(Cliente cliente) throws ClienteNegocioException {
		...
		// Validación de que el nombre solo contenga letras, incluyendo letras con acentos y la ñ
		...
		// Validación de que el apellido solo contenga letras, incluyendo letras con acentos y la ñ
